...
/**
 * Simple wrapper for binary semaphore. A semaphore is
 ...
 * This feature allows using semaphores for signalling
 * a thread. The receiver thread will block on some
 * semaphore
 *
 * @code
 * while (true ) {
...
public:
	 ...
	 */
	CBinarySemaphore(bool isLocked, bool isProcessShared);
